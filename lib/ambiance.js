...
export const AMBIANCES = {
  ...
  restaurant: {
    libelle: "Restaurant animé",
    description: "Une salle bondée entendue depuis la salle elle-même : des tables proches, des conversations qui se détachent. Le plus vivant du catalogue (8,5 dB de relief), et celui qui va à une pizzeria qui décroche en plein service.",
    fichier: "restaurant.wav",
  },
  rue: {
    libelle: "Rue",
